package cn.netdisk.wospace.common.annotation;

import cn.netdisk.wospace.util.Utils;
...
public  class SystemLogAspect {
    ...
    //Controller层切点
    @Pointcut("@annotation(cn.netdisk.wospace.common.annotation.SystemControllerLog)")
