package cn.netdisk.wospace.common.rule;


import cn.netdisk.wospace.common.exception.BizException;
import cn.netdisk.wospace.common.util.MyStringUtil;
...
public class ParamsChecker {
    ...
    public static Integer Conver2Int(String param, int defvale)  {
        if (MyStringUtil.isNumber(param))
